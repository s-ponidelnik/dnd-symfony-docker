...
class SourceController extends AbstractController
{
    ...
    {
        return $this->render('source/index.html.twig', ['sources' => $sourceRepository->findAll()]);
    }
    ...
    {
        return $this->render('source/show.html.twig', ['source' => $source]);
    }
    ...
    public function edit(Request $request, Source $source): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('source_index', ['id' => $source->getId()]);
        }
